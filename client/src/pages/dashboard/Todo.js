          ...
          <Form.Row>
            ...
            <Col xs={12} sm={12} md={4}>
              <Input
                ...
                name="tag"
                autoComplete="off"
                pClassName={tagId === '66a8c90bcfb0ac12903b8232' ? 'd-none' : ''}
              >
                {tags.map((tag) => {
                  return (
                    <option
                      disabled={tag._id === '66a8c90bcfb0ac12903b8233'}
                      option-id={tag._id}
                      key={tag._id}
                    >
                      {tag.name}
              ...
              <Input
                ...
                type="text"
                pClassName={tagId !== '66a8c90bcfb0ac12903b8232' ? 'd-none' : 'd-block'}
                value={tagId === '66a8c90bcfb0ac12903b8232' ? tag : ''}
                onChange={
                  tagId === '66a8c90bcfb0ac12903b8232' ? (e) => onChange(e) : () => {}
                }
                name="tag"
                autoComplete="off"
              />
